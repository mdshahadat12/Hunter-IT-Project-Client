    ...
    <div className="relative flex md:w-1/2 mx-auto my-20 flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-md">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="p-6 pt-0">
          <input
            className="block cursor-pointer w-full select-none rounded-lg bg-gradient-to-tr from-orange-600 to-orange-400 py-3 px-6 text-center align-middle font-sans text-xs font-bold uppercase text-white shadow-md shadow-orange-500/20 transition-all hover:shadow-lg hover:shadow-orange-500/40 active:opacity-[0.85] disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
            type="submit"
            value={'Registration'}
